...
impl IType {
    ...
    pub fn imm(&self) -> u32 {
        ((self.0 >> 20 & 0b1111_1111_1111) ^ (1 << 11))
            .overflowing_sub(1 << 11)
            .0
    }
}
...
impl SType {
    ...
    pub fn imm(&self) -> u32 {
        (((self.0 >> (25 - 5) & 0b1111_1110_0000) | (self.0 >> 7 & 0b0000_0001_1111)) ^ (1 << 11))
            .overflowing_sub(1 << 11)
            .0
    }
}
